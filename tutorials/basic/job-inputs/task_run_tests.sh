...
export GOPATH=$(pwd)/gopath:$(pwd)/gopath/src/github.com/syn-ack-zack/simple-go-web-app/Godeps/_workspace
cd gopath/src/github.com/syn-ack-zack/simple-go-web-app/
